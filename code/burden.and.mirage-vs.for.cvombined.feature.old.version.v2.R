setwd("C:\\Shengtong\\Research\\rare-var\\rare-var-project\\code\\")
...
evid.exon[[1+length(exon.cutoff)]]=Anno.Data$ID
pois.test=test.func(evid.exon[[1+length(exon.cutoff)]], var.data, N1, N0)
