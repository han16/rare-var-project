...
save(num_variants, Gene.Risk.Status, MIRAGE.pvalue, MIRAGE.BF, Fisher.pvalue, SKATO.pvalue, CMC.pvalue, 
     ASUM.pvalue, Fisher.separate.pvalue, ACAT.pvalue, file="C:\\Users\\hans\\OneDrive - Marquette University\\RareVariant\\simulation\\random_num_variants\\7methods_delta0.05_MAC_threshold10.gammamean335_5rep.RData")
