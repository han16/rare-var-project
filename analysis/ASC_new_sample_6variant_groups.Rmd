...
top_gene_summary=data.frame(Gene=BF_proband_AllGene_sorted$Gene[1:top_gene_number], BF=BF_proband_AllGene_sorted$BF_filtered[1:top_gene_number], posterior=round(post_prob[1:top_gene_number],4),Evidence=Evidence, ASC_gene=ASC_gene_status)
