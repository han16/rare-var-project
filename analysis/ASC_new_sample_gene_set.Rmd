...
* one outlier with extremely small MIRAGE_Vs p value is gene set `AutismKB_MPC<1_0.0001<AF<0.001` with 6802 (transmitted) vs 6914 (untransmitted) on 1901 loci. Burden p value: 0.9839; MIRAGE_VS p value: 5.195326e-15. 
...
ggplot(summary, aes(x=method, y=pvalue, fill=method)) + 
  ...
  ggtitle("Variant set: constraint gene+AF<0.0001")+
  theme(plot.title = element_text(hjust = 0.5, size=15))+  #center the title 
