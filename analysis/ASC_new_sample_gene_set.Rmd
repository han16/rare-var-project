...
* this result is based on data including introns and UTRs. 
...
data.frame(Gene=BF_proband_AllGene_sorted$Gene[1:100], BF=round(BF_proband_AllGene_sorted$BF[1:100], 4), post.prob=round(BF_proband_AllGene_sorted$post.prob[1:100],4))%>%
datatable(extensions = 'Buttons',
            options = list(dom = 'Blfrtip',
                           buttons = c('copy', 'csv', 'excel', 'pdf', 'print'),
                           lengthMenu = list(c(10,25,50,-1),
...
#res=mirage(mirage_toy,n1=4315,n2=4315) # test mirage function 
#write.csv(mirage_result$BF.PP.gene, file="../output/KyleData/BF.proband.AllGene_1015_2022.csv")
```
