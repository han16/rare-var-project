...
for (i in 1:10) # for each gene set
...
#as_tibble(para_est)
#write.csv(para_est, file="../output/KyleData/MIRAGE_VS.for.180.variant.group.proband_0829_2022.csv") # This one may not exclude introns 

#write.csv(para_est, file="../output/KyleData/MIRAGE_VS.for.180.variant.group.proband_0112_2023.csv")  # this one DOES exclude introns 
...
#para_est=read.csv("../output/KyleData/MIRAGE_VS.for.180.variant.group.proband_0829_2022.csv", header=T)  # This one may not exclude introns
para_est=read.csv("../output/KyleData/MIRAGE_VS.for.180.variant.group.proband_0112_2023.csv", header=T)  # This one DOES exclude introns
############### plot the results 
...
* exlude introns `!str_detect(Consequence, 'intron_variant')`
...
* [Burden analysis for 6 variant groups](ASC_new_sample_6variant_groups.html)
...
#write.csv(result$full.info[[which(result$BayesFactor$Gene=="PTEN")]], file="../output/KyleData/BF.proband.AllGene_6vargroups_gene_PTEN_0103_2023.csv") # output gene PTEN

#write.csv(result$full.info[[which(result$BayesFactor$Gene=="SUPT5H")]], file="../output/KyleData/BF.proband.AllGene_6vargroups_gene_SUPT5H_0103_2023.csv") # output gene SUPT5H
...
* `BF_filtered` is the product of BF taking out the groups with negative burden but with BF>1.1, `BF` is original BF with all variant groups 
...
5. [PTEN](https://marq-my.sharepoint.com/:x:/g/personal/shengtong_han_marquette_edu/EbMhsZg-1kdBhdZvUpCVJ9kBw8Yj-XysfUKDupcQDTDo6A?e=TDAaVx)
6. [SUPT5H](https://marq-my.sharepoint.com/:x:/g/personal/shengtong_han_marquette_edu/EX9tMzKEj6NAlopRWs1-N2gByBNHYmhRKtSh02D9mq-SBA?e=KyqfyZ) `19:39465003:C:T SUPT5H       6(T)        0(UT)           5 11.1279598`
