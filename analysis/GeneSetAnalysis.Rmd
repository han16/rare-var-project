...
result.summary=data.frame(Gene=Gene, OR=OR, pval=pval)
# pdf("../../Figure/burden_geneset.pdf")
  ...
  ylab("")+xlab("Gene")+ ggtitle("Burden analysis for gene sets")+
   geom_point(aes(x=Gene, y=-log(pval, base=10), size=-log(pval, base=10), color=Gene))+ 
    coord_flip()+
...
# pdf("../../Figure/burden_constgene.pdf")
  ...
  geom_bar(stat="identity")+
  ylab("")+xlab("Cate")+ ggtitle("Burden analysis for eight categories")+
   geom_point(aes(x=Cate, y=-log(pval, base=10), size=-log(pval, base=10), color=Cate))+ 
