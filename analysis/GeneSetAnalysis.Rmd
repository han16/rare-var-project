...
top10mirage_enrichment=ggplot(top10mirage.enrichment.tidy, aes(group, percent)) + 
  ...
  ggtitle("(C) Enrichment")+
  #theme(plot.title = element_text(size=12))
   theme(legend.title = element_blank())+
  geom_signif(annotations ="p=8.3E-4", y_position = 0.45  ,xmin=0.7, xmax=1.2, size=1, vjust=-0.5)+
  geom_signif(annotations ="p=2.8E-3", y_position = 0.45  ,xmin=1.7, xmax=2.2, size=1, vjust=-0.5)+
  geom_signif(annotations ="p=2.5E-4", y_position = 0.75  ,xmin=2.7, xmax=3.2, size=1, vjust=-0.5)+
