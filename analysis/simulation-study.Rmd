...
##################### true gamma.bar=3, use gamma.bar=3 ##########
rm("beta.k", "BF.gene", "mirage.pvalue", "skat.pvalue", "fisher.pvalue")
load("../output/BayesianFDR/Mixed_Gene_Gammamean3_useGammabar3.delta0.1.RData")
BF.gene=BF.gene[complete.cases(BF.gene), ]
Bayes_factor=tibble(BF=BF.gene[nrow(BF.gene),])
...
##################### true gamma.bar=3, use gamma.bar=4 ##########
rm("beta.k", "BF.gene", "mirage.pvalue", "skat.pvalue", "fisher.pvalue")
load("../output/BayesianFDR/Mixed_Gene_Gammamean3_useGammabar4.delta0.1.RData")
BF.gene=BF.gene[complete.cases(BF.gene), ]
Bayes_factor=tibble(BF=BF.gene[nrow(BF.gene),])
...
##################### true gamma.bar=3, use gamma.bar=5 ##########
rm("beta.k", "BF.gene", "mirage.pvalue", "skat.pvalue", "fisher.pvalue")
load("../output/BayesianFDR/Mixed_Gene_Gammamean3_useGammabar5.delta0.1.RData")
BF.gene=BF.gene[complete.cases(BF.gene), ]
Bayes_factor=tibble(BF=BF.gene[nrow(BF.gene),])
...
##################### true gamma.bar=3, use gamma.bar=6 ##########
rm("beta.k", "BF.gene", "mirage.pvalue", "skat.pvalue", "fisher.pvalue")
load("../output/BayesianFDR/Mixed_Gene_Gammamean3_useGammabar6.delta0.1.RData")
BF.gene=BF.gene[complete.cases(BF.gene), ]
Bayes_factor=tibble(BF=BF.gene[nrow(BF.gene),])
...
tau_fdr6=tibble(tau=tau, bar6_fdr=FDR)%>%drop_na()  # drop rows with NA



tau_fdr_combine=full_join(full_join(full_join(tau_fdr3, tau_fdr4), tau_fdr5), tau_fdr6)
tau_fdr_combine_tidy=tau_fdr_combine %>% gather(gamma.bar, fdr, bar3_fdr:bar6_fdr)
tau_fdr_combine_tidy$gamma.bar=tau_fdr_combine_tidy$gamma.bar %>% recode(bar3_fdr="3", bar4_fdr="4", bar5_fdr="5", bar6_fdr="6") 

g1=ggplot(tau_fdr_combine_tidy)+
...
#################################################################################################################
#################################################################################################################
##################### true gamma.bar=4, use gamma.bar=3 ##########
rm("beta.k", "BF.gene", "mirage.pvalue", "skat.pvalue", "fisher.pvalue")
load("../output/BayesianFDR/Mixed_Gene_Gammamean4_useGammabar3.delta0.1.RData")
BF.gene=BF.gene[complete.cases(BF.gene), ]
Bayes_factor=tibble(BF=BF.gene[nrow(BF.gene),])
...
##################### true gamma.bar=3, use gamma.bar=4 ##########
rm("beta.k", "BF.gene", "mirage.pvalue", "skat.pvalue", "fisher.pvalue")
load("../output/BayesianFDR/Mixed_Gene_Gammamean4_useGammabar4.delta0.1.RData")
BF.gene=BF.gene[complete.cases(BF.gene), ]
Bayes_factor=tibble(BF=BF.gene[nrow(BF.gene),])
...
##################### true gamma.bar=3, use gamma.bar=5 ##########
rm("beta.k", "BF.gene", "mirage.pvalue", "skat.pvalue", "fisher.pvalue")
load("../output/BayesianFDR/Mixed_Gene_Gammamean4_useGammabar5.delta0.1.RData")
BF.gene=BF.gene[complete.cases(BF.gene), ]
Bayes_factor=tibble(BF=BF.gene[nrow(BF.gene),])
...
##################### true gamma.bar=3, use gamma.bar=6 ##########
rm("beta.k", "BF.gene", "mirage.pvalue", "skat.pvalue", "fisher.pvalue")
load("../output/BayesianFDR/Mixed_Gene_Gammamean4_useGammabar6.delta0.1.RData")
BF.gene=BF.gene[complete.cases(BF.gene), ]
Bayes_factor=tibble(BF=BF.gene[nrow(BF.gene),])
...
g2=ggplot(tau_fdr_combine_tidy)+
  geom_point(aes(x=tau, y=fdr, color=gamma.bar))+
  xlab(expression(paste(tau)))+ylab("FDR")+
...
##################### true gamma.bar=5, use gamma.bar=5 ##########
rm("beta.k", "BF.gene", "mirage.pvalue", "skat.pvalue", "fisher.pvalue")
load("../output/BayesianFDR/Mixed_Gene_Gammamean5_useGammabar5.delta0.1.RData")
BF.gene=BF.gene[complete.cases(BF.gene), ]
Bayes_factor=tibble(BF=BF.gene[nrow(BF.gene),])
...
##################### true gamma.bar=5, use gamma.bar=6 ##########
rm("beta.k", "BF.gene", "mirage.pvalue", "skat.pvalue", "fisher.pvalue")
load("../output/BayesianFDR/Mixed_Gene_Gammamean5_useGammabar6.delta0.1.RData")
BF.gene=BF.gene[complete.cases(BF.gene), ]
Bayes_factor=tibble(BF=BF.gene[nrow(BF.gene),])
...
g3=ggplot(tau_fdr_combine_tidy)+
  geom_point(aes(x=tau, y=fdr, color=gamma.bar))+
  xlab(expression(paste(tau)))+ylab("FDR")+
  ggtitle(expression(paste("True ", bar(gamma), "=5")))+
  theme(text = element_text(size=10),
...
rm("beta.k", "BF.gene", "mirage.pvalue", "skat.pvalue", "fisher.pvalue")
load("../output/BayesianFDR/Mixed_Gene_Gammamean6_useGammabar3.delta0.1.RData")
BF.gene=BF.gene[complete.cases(BF.gene), ]
Bayes_factor=tibble(BF=BF.gene[nrow(BF.gene),])
...
##################### true gamma.bar=5, use gamma.bar=4 ##########
rm("beta.k", "BF.gene", "mirage.pvalue", "skat.pvalue", "fisher.pvalue")
load("../output/BayesianFDR/Mixed_Gene_Gammamean6_useGammabar4.delta0.1.RData")
BF.gene=BF.gene[complete.cases(BF.gene), ]
Bayes_factor=tibble(BF=BF.gene[nrow(BF.gene),])
...
##################### true gamma.bar=5, use gamma.bar=5 ##########
rm("beta.k", "BF.gene", "mirage.pvalue", "skat.pvalue", "fisher.pvalue")
load("../output/BayesianFDR/Mixed_Gene_Gammamean6_useGammabar5.delta0.1.RData")
BF.gene=BF.gene[complete.cases(BF.gene), ]
Bayes_factor=tibble(BF=BF.gene[nrow(BF.gene),])
...
##################### true gamma.bar=5, use gamma.bar=6 ##########
rm("beta.k", "BF.gene", "mirage.pvalue", "skat.pvalue", "fisher.pvalue")
load("../output/BayesianFDR/Mixed_Gene_Gammamean6_useGammabar6.delta0.1.RData")
BF.gene=BF.gene[complete.cases(BF.gene), ]
Bayes_factor=tibble(BF=BF.gene[nrow(BF.gene),])
...
g4=ggplot(tau_fdr_combine_tidy)+
  geom_point(aes(x=tau, y=fdr, color=gamma.bar))+
  xlab(expression(paste(tau)))+ylab("FDR")+
