...
powereta03_gather$Method=powereta03_gather$Method %>% recode(MIRAGE_VS="MIRAGE-VS") # change the method name 
...
power_gather_combine$Method=power_gather_combine$Method %>% recode(MIRAGE_VS="MIRAGE-VS")
...
null.pvalue.combine.significant.count=tibble(Method=c(rep(c("MIRAGE-VS", "Burden", "SKATO"),3)), count=c(21,26,31, 14,38,45, 15,37,42),sample.size=rep(c(1000,3000, 5000), each=3))
...
null.pvalue.combine.significant.count=tibble(Method=c(rep(c("MIRAGE-VS", "Burden", "SKATO"),4)), count=c(22,32,39, 22,46,55, 25,32,44, 11,35,47),gammabar=rep(3:6, each=3))
...
ggplot(null.pvalue.combine.significant.count, aes(x=gammabar, y=count/1000, fill=Method)) +
  ...
  geom_hline(yintercept=0.05, linetype="dashed", color = "red")+
  xlab(expression(paste(bar(gamma))))+
ylab("False positive (p values less than 5%) rate" )
#dev.off()
```
...
method=rep(c( "Burden(0.556)", "SKATO(0.724)", "MIRAGE(0.839)", "CMC(0.755)", "ASUM(0.672)"), each=num_run)

roc_single_run=data.frame(D=Ui, m=c(fisher_pvalue,skato_pvalue, -mirage_BF, cmc_pvalue, asum_pvalue), method=method)
p.basic=ggplot(roc_single_run, aes(d = D, m = m, color=method), size=2) + 
...
method=rep(c("Burden(0.446)", "SKATO(0.540)", "MIRAGE(0.805)", "CMC(0.563)", "ASUM(0.417)"), each=num_run)
...
method=rep(c( "Burden(0.513)", "SKATO(0.722)", "MIRAGE(0.821)", "CMC(0.723)", "ASUM(0.650)"), each=num_run)
...
method=rep(c( "Burden(0.543)", "SKATO(0.756)", "MIRAGE(0.843)", "CMC(0.744)", "ASUM(0.672)"), each=num_run)
...
```{r, echo=F}
#pdf("C:/Users/han24/OneDrive - UWM/rare-var/Figure/Main/Fig3-power_comparison_MIRAGE-gene.pdf")
...
for (i in 3:6)
{
 ...
 rm("beta.k", "BF.gene", "mirage.pvalue", "skat.pvalue", "fisher.pvalue", "Ui")
 load(paste("../output/BayesianFDR/Mixed_Gene_Gammamean3_", "useGammabar", i, ".delta0.1.RData", sep="")) 
 BF.gene=BF.gene[complete.cases(BF.gene), ]
 Bayes.factor=tibble(BF=BF.gene[nrow(BF.gene),])
 gene.post=Bayes.factor %>% mutate(post.prob=gene.prior*BF/(1-gene.prior+gene.prior*BF))
 gene.post=as_tibble(cbind(gene.post, RiskStatus=Ui))
...
for (i in 3:6)
{
 ############ compute posterior probability for every gene ##########
 rm("beta.k", "BF.gene", "mirage.pvalue", "skat.pvalue", "fisher.pvalue", "Ui")
 load(paste("../output/BayesianFDR/Mixed_Gene_Gammamean4_", "useGammabar", i, ".delta0.1.RData", sep="")) 
 BF.gene=BF.gene[complete.cases(BF.gene), ]
 Bayes.factor=tibble(BF=BF.gene[nrow(BF.gene),])
 gene.post=Bayes.factor %>% mutate(post.prob=gene.prior*BF/(1-gene.prior+gene.prior*BF))
 gene.post=as_tibble(cbind(gene.post, RiskStatus=Ui))
...
combine.bayes.actual.fdr$Gamma.bar.use<-combine.bayes.actual.fdr$Gamma.bar.use %>% recode("3"="3", "4"="4", "5"="5", "6"="6")
#null.pvalue.combine$Method=null.pvalue.combine$Method %>% recode(MIRAGE.pvalue="MIRAGE_VS", Fisher.pvalue="Burden", SKATO.pvalue="SKATO")
g2=ggplot(combine.bayes.actual.fdr, aes(x=Bayes.FDR, y=Actual.FDR, color=Gamma.bar.use))+
  geom_abline(intercept =0, slope =1, 
                 linetype="solid", size=1.5, col="black")+
  geom_point()+
...
for (i in 3:6)
{
 ############ compute posterior probability for every gene ##########
 rm("beta.k", "BF.gene", "mirage.pvalue", "skat.pvalue", "fisher.pvalue", "Ui")
 load(paste("../output/BayesianFDR/Mixed_Gene_Gammamean5_", "useGammabar", i, ".delta0.1.RData", sep="")) 
 BF.gene=BF.gene[complete.cases(BF.gene), ]
 Bayes.factor=tibble(BF=BF.gene[nrow(BF.gene),])
 gene.post=Bayes.factor %>% mutate(post.prob=gene.prior*BF/(1-gene.prior+gene.prior*BF))
 gene.post=as_tibble(cbind(gene.post, RiskStatus=Ui))
...
combine.bayes.actual.fdr$Gamma.bar.use<-combine.bayes.actual.fdr$Gamma.bar.use %>% recode("3"="3", "4"="4", "5"="5", "6"="6")
#null.pvalue.combine$Method=null.pvalue.combine$Method %>% recode(MIRAGE.pvalue="MIRAGE_VS", Fisher.pvalue="Burden", SKATO.pvalue="SKATO")
g3=ggplot(combine.bayes.actual.fdr, aes(x=Bayes.FDR, y=Actual.FDR, color=Gamma.bar.use))+
  geom_abline(intercept =0, slope =1, 
                 linetype="solid", size=1.5, col="black")+
  geom_point()+
  ggtitle(expression(paste("True ", bar(gamma), "=5")))+
...
###############################################################################################################
###############################################################################################################
##################### true gamma.bar=6, use gamma.bar=3 ##########
...
for (i in 3:6)
{
 ############ compute posterior probability for every gene ##########
 rm("beta.k", "BF.gene", "mirage.pvalue", "skat.pvalue", "fisher.pvalue", "Ui")
 load(paste("../output/BayesianFDR/Mixed_Gene_Gammamean6_", "useGammabar", i, ".delta0.1.RData", sep="")) 
 BF.gene=BF.gene[complete.cases(BF.gene), ]
 Bayes.factor=tibble(BF=BF.gene[nrow(BF.gene),])
 gene.post=Bayes.factor %>% mutate(post.prob=gene.prior*BF/(1-gene.prior+gene.prior*BF))
 gene.post=as_tibble(cbind(gene.post, RiskStatus=Ui))
...
combine.bayes.actual.fdr$Gamma.bar.use<-combine.bayes.actual.fdr$Gamma.bar.use %>% recode("3"="3", "4"="4", "5"="5", "6"="6")
#null.pvalue.combine$Method=null.pvalue.combine$Method %>% recode(MIRAGE.pvalue="MIRAGE_VS", Fisher.pvalue="Burden", SKATO.pvalue="SKATO")
g4=ggplot(combine.bayes.actual.fdr, aes(x=Bayes.FDR, y=Actual.FDR, color=Gamma.bar.use))+
  geom_abline(intercept =0, slope =1, 
                 linetype="solid", size=1.5, col="black")+
  geom_point()+
