...
Simulated one data set, $N1=N0=3000$, 10\% of 1000 genes are risk genes. Every gene has 100 variants in three variant  groups with $\eta_1=0.05, \eta_2=0.2, \eta_3=0.5$ and the proportion of variants are 30\%, 30\% and 10\%. Each data set has one fixed $\bar{\gamma}$ and it is varied at $\bar{\gamma}=3,4,5,6$. Other parameters are pretty the same as before 
$\alpha_0=0.1, \beta_0=1000,\alpha= 0.1, \beta=2000,\bar{\gamma}=5,\sigma= 1$.
