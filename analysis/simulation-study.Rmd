...
$K=2$. Set $\beta_1=0.05, \beta_2=2$. Other parameters are the same as in Case 1.  When there are more than 2 groups, $A_{ij}$ must be designed carefully such that all columns (all annotations) have as little overlap as possible. Otherwise, the method have difficulty in distinguishing between them, leading to poor estimate. In estimation below, these two factures have no overlap. 



N1=N0|10,000 | 50,000 | 100,000|
--------|-------|--------|-----------------------------------------
 $\widehat{\beta_1}_{MLE}$ by Optim | 0.3472 (0.0239) | |  
 $\widehat{\beta_2}_{MLE}$ by Optim | 2.7807 (0.0919) | | 
