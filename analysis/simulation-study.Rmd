...
load("../output/Var_specific_bargamma_MixedGene_MixtureVariant/7methods_delta0.1_gammamean335.RData")
i=1
Ui=Gene.Risk.Status[[i]]
mirage_pvalue=MIRAGE.pvalue[[i]]
mirage_BF=MIRAGE.BF[[i]]
...
method=rep(c( "Burden(0.683)", "SKAT-O(0.732)", "MIRAGE(0.856)", "CMC(0.744)", "ASUM(0.646)", "ACAT(0.602)"), each=num_run)
...
```{r,echo=F, message=F, warning=F}
rm("Ui", "mirage_pvalue", "mirage_BF", "fisher_pvalue", "skato_pvalue")
load("../output/Var_specific_bargamma_MixedGene_MixtureVariant/7methods_delta0.01_gammamean335.RData")
i=2
Ui=Gene.Risk.Status[[i]]
mirage_pvalue=MIRAGE.pvalue[[i]]
mirage_BF=MIRAGE.BF[[i]]
...
method=rep(c("Burden(0.734)", "SKAT-O(0.670)", "MIRAGE(0.818)", "CMC(0.766)", "ASUM(0.670)", "ACAT(0.655)"), each=num_run) # AUC is from round(calc_auc(p1.basic)$AUC, 2) 
...
################################ delta=0.05
rm("Ui", "mirage_pvalue", "mirage_BF", "fisher_pvalue", "skato_pvalue")
load("../output/Var_specific_bargamma_MixedGene_MixtureVariant/7methods_delta0.05_gammamean335.RData")
i=1
Ui=Gene.Risk.Status[[i]]
mirage_pvalue=MIRAGE.pvalue[[i]]
mirage_BF=MIRAGE.BF[[i]]
...
method=rep(c( "Burden(0.687)", "SKAT-O(0.739)", "MIRAGE(0.857)", "CMC(0.768)", "ASUM(0.671)", "ACAT(0.553)"), each=num_run)
...
############################# delta=0.2
rm("Ui", "mirage_pvalue", "mirage_BF", "fisher_pvalue", "skato_pvalue")
load("../output/Var_specific_bargamma_MixedGene_MixtureVariant/7methods_delta0.2_gammamean335.RData")
i=1
Ui=Gene.Risk.Status[[i]]
mirage_pvalue=MIRAGE.pvalue[[i]]
mirage_BF=MIRAGE.BF[[i]]
...
method=rep(c( "Burden(0.755)", "SKAT-O(0.811)", "MIRAGE(0.875)", "CMC(0.803)", "ASUM(0.705)", "ACAT(0.661)"), each=num_run)
...
#p_delta0.2
################## comparison among three burdens ########
method=rep(c( "Burden(0.543)", "Burden-adj(0.526)", "Burden-combine(0.464)"), each=num_run)
...
```{r, echo=F, message=F, warning=F}
#pdf("C:/Users/hans/OneDrive - Marquette University/RareVariant/Fig3-power_comparison_MIRAGE-gene_2023_0314.pdf")
