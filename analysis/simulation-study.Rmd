...
method=rep(c( "Burden(0.556)", "SKAT-O(0.724)", "MIRAGE(0.839)", "CMC(0.755)", "ASUM(0.672)"), each=num_run)
...
method=rep(c("Burden(0.446)", "SKAT-O(0.540)", "MIRAGE(0.805)", "CMC(0.563)", "ASUM(0.417)"), each=num_run)
...
method=rep(c( "Burden(0.513)", "SKAT-O(0.722)", "MIRAGE(0.821)", "CMC(0.723)", "ASUM(0.650)"), each=num_run)
...
method=rep(c( "Burden(0.543)", "SKAT-O(0.756)", "MIRAGE(0.843)", "CMC(0.744)", "ASUM(0.672)"), each=num_run)
