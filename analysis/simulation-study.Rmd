...
```{r,echo=F, message=F, warning=F}
rm("Ui", "mirage_pvalue", "mirage_BF", "fisher_pvalue", "skato_pvalue", "cmc_pvalue", "asum_pvalue", "acat.pvalue")
...
method=rep(c( "Burden(0.513)", "Burden-adj(0.518)", "Burden-combine(0.456)"), each=num_run)
...
#p_delta0.2
################## comparison among three burdens ########
method=rep(c( "Burden(0.)", "Burden-adj(0.526)", "Burden-combine(0.464)"), each=num_run)
...
```{r, echo=F, message=F, warning=F}
#pdf("C:/Users/hans/OneDrive - Marquette University/RareVariant/Fig3-power_comparison_MIRAGE-gene_2023_0413.pdf")
...
```{r, echo=F, message=F, warning=F}
#pdf("C:/Users/han24/OneDrive - UWM/rare-var/Figure/Supp/Fig-power_comparison_three-burden-gene.pdf")
grid.arrange(p_delta0.01_burden, p_delta0.05_burden, p_delta0.1_burden, p_delta0.2_burden, nrow=2) 
#dev.off()
...
p1=ggplot(actual.fdr.summary, aes(x=bar.gamma, y=mean, group=1)) + 
  ...
  theme(plot.title = element_text(hjust = 0.5, size=10))+  #center the title 
  xlab(expression(paste(bar(gamma))))+
  ylab("Actual FDR")+ylim(c(-0.01, max.ylab))+
  guides(fill=guide_legend(title=NULL))+
  #ylim(0.05,0.15)+
...
p3=ggplot(actual.fdr.summary, aes(x=bar.gamma, y=mean, group=1)) + 
  ...
  theme(plot.title = element_text(hjust = 0.5, size=10))+  #center the title 
  xlab(expression(paste(bar(gamma))))+
  ylab("Actual  FDR")+ylim(c(0, max.ylab))+  
  guides(fill=guide_legend(title=NULL))+
  #ylim(0.05,0.15)+
   geom_hline(yintercept=bayesian.fdr,linetype="dashed", color = "red")+
  theme(axis.title.y=element_text(size=8)) # adjust text size for y labels
...
#pdf("C:/Users/han24/OneDrive - UWM/rare-var/Figure/Supp/Fig-MIRAGE_gene_Bayes_FDR_misspecified_gammabar.pdf")
