...
We simulated 100  variants in one category. $\eta= 0.4$, true $\bar{\gamma}=5$,   and we vary $\bar{\gamma}=3,4,5,6$ and $N1=N0=1000, 3000, 5000$,, $\alpha=\alpha_0=0.1$, $\beta=2000, \beta_0=1000$. We independetly run Monte Carlo  100 times and calculate the true positive rate for MIRAGE-VS, burden test and SKATO.  Note here there is no gene information. MIRAGE-VS basically estimates the proportion of risk variants $\hat{\eta}$, and performs the likelihood ratio test to get p value.  
...
########### sample size 1000
gammabar3=loadRData("../output/Power_Analysis_MIRAGE-VS/varyGammamean/gamma.bar.3.true5.eta.0.4.sample.size1000.RData")
gammabar4=loadRData("../output/Power_Analysis_MIRAGE-VS/varyGammamean/gamma.bar.4.true5.eta.0.4.sample.size1000.RData")
gammabar5=loadRData("../output/Power_Analysis_MIRAGE-VS/varyGammamean/gamma.bar.5.true5.eta.0.4.sample.size1000.RData")
gammabar6=loadRData("../output/Power_Analysis_MIRAGE-VS/varyGammamean/gamma.bar.6.true5.eta.0.4.sample.size1000.RData")
...
g3=ggplot(power_gather, aes(x=gamma_bar, y=TPR/100, group=Method))+
  geom_line(aes(color=Method), size=0.8)+
  ylim(0,1)+
  geom_point(aes(color=Method, shape=Method))+
...
########### sample size 3000
gammabar3=loadRData("../output/Power_Analysis_MIRAGE-VS/varyGammamean/gamma.bar.3.true5.eta.0.4.sample.size3000.RData")
gammabar4=loadRData("../output/Power_Analysis_MIRAGE-VS/varyGammamean/gamma.bar.4.true5.eta.0.4.sample.size3000.RData")
gammabar5=loadRData("../output/Power_Analysis_MIRAGE-VS/varyGammamean/gamma.bar.5.true5.eta.0.4.sample.size3000.RData")
gammabar6=loadRData("../output/Power_Analysis_MIRAGE-VS/varyGammamean/gamma.bar.6.true5.eta.0.4.sample.size3000.RData")
gammabar3_mirage=as.numeric(as_tibble(gammabar3) %>% filter(MIRAGE.pvalue<sig.cutoff) %>% tally())
gammabar3_burden=as.numeric(as_tibble(gammabar3) %>% filter(Fisher.pvalue<sig.cutoff) %>% tally())
gammabar3_skato=as.numeric(as_tibble(gammabar3) %>% filter(SKATO.pvalue<sig.cutoff) %>% tally())
...
g2=ggplot(power_gather, aes(x=gamma_bar, y=TPR/100, group=Method))+
  geom_line(aes(color=Method), size=0.8)+
  ylim(0,1)+
  geom_point(aes(color=Method, shape=Method))+
  xlab(expression(paste(bar(gamma))))+ 
...
########### sample size 5000
gammabar3=loadRData("../output/Power_Analysis_MIRAGE-VS/varyGammamean/gamma.bar.3.true5.eta.0.4.RData")
gammabar4=loadRData("../output/Power_Analysis_MIRAGE-VS/varyGammamean/gamma.bar.4.true5.eta.0.4.RData")
gammabar5=loadRData("../output/Power_Analysis_MIRAGE-VS/varyGammamean/gamma.bar.5.true5.eta.0.4.RData")
gammabar6=loadRData("../output/Power_Analysis_MIRAGE-VS/varyGammamean/gamma.bar.6.true5.eta.0.4.RData")
gammabar3_mirage=as.numeric(as_tibble(gammabar3) %>% filter(MIRAGE.pvalue<sig.cutoff) %>% tally())
gammabar3_burden=as.numeric(as_tibble(gammabar3) %>% filter(Fisher.pvalue<sig.cutoff) %>% tally())
gammabar3_skato=as.numeric(as_tibble(gammabar3) %>% filter(SKATO.pvalue<sig.cutoff) %>% tally())
...
g1=ggplot(power_gather, aes(x=gamma_bar, y=TPR/100, group=Method))+
  geom_line(aes(color=Method), size=0.8)+
  ylim(0,1)+
  geom_point(aes(color=Method, shape=Method))+
  xlab(expression(paste(bar(gamma))))+ 
...
ggplot(power_gather_combine, aes(x=gamma_bar, y=TPR/100, group=Method))+
  geom_line(aes(color=Method), size=0.8)+
  ylim(0,1)+
  geom_point(aes(color=Method, shape=Method))+
  xlab(expression(paste(bar(gamma))))+ 
...
To investigate the type one error, we simulated 100 independent data sets, with varying sample size $N1=N0=1000, 3000, 5000$, 100 variants in one group; no risk variants, i.e., $\eta=0$ and other parameters are pretty the same as before 
...
```{r, echo=F}
null.pvalue.SS1000=loadRData("../output/TypeOneError/Simulation_OneGene_OneNonrisk_VarGroup_SS1000.RData")
...
null.pvalue.SS3000=loadRData("../output/TypeOneError/Simulation_OneGene_OneNonrisk_VarGroup_SS3000.RData")
...
null.pvalue.SS5000=loadRData("../output/TypeOneError/Simulation_OneGene_OneNonrisk_VarGroup_SS5000.RData")
...
null.pvalue.combine.significant.count=tibble(Method=c(rep(c("MIRAGE-VS", "Burden", "SKATO"),3)), count=c(4,2,3, 1,2,4, 4,2,6),sample.size=rep(c(1000,3000, 5000), each=3))
null.pvalue.combine.significant.count$sample.size=as.factor(null.pvalue.combine.significant.count$sample.size)
ggplot(null.pvalue.combine.significant.count, aes(x=sample.size, y=count/100, fill=Method)) +
  geom_bar(stat="identity", position="dodge")+
  geom_hline(yintercept=0.05, linetype="dashed", color = "red")+
  xlab("N1=N0")+ylab("% of test with p value less than 5%" )+
  theme_classic()
...
```{r, echo=F}
null.pvalue.truegamma5.use3=loadRData("../output/TypeOneError/Simulation_OneGene_OneNonrisk_VarGroup_SS3000_truegamma5_use3.RData")
...
null.pvalue.truegamma5.use4=loadRData("../output/TypeOneError/Simulation_OneGene_OneNonrisk_VarGroup_SS3000_truegamma5_use4.RData")
...
null.pvalue.truegamma5.use5=loadRData("../output/TypeOneError/Simulation_OneGene_OneNonrisk_VarGroup_SS3000_truegamma5_use5.RData")
...
null.pvalue.truegamma5.use6=loadRData("../output/TypeOneError/Simulation_OneGene_OneNonrisk_VarGroup_SS3000_truegamma5_use6.RData")
...
null.pvalue.combine.significant.count=tibble(Method=c(rep(c("MIRAGE-VS", "Burden", "SKATO"),4)), count=c(3,4,5, 4,2,1, 6,3,4, 1,7,6),gammabar=rep(3:6, each=3))
null.pvalue.combine.significant.count$gammabar=as.factor(null.pvalue.combine.significant.count$gammabar)
ggplot(null.pvalue.combine.significant.count, aes(x=gammabar, y=count/100, fill=Method)) +
  geom_bar(stat="identity", position="dodge")+
  ggtitle(expression(paste("True ", bar(gamma), "=5")))+
  theme_classic()+
  ...
  geom_hline(yintercept=0.05, linetype="dashed", color = "red")+
  xlab(expression(paste(bar(gamma))))+
ylab("% of test with p value less than 5%" )
```

This is to test how sensitive is the effect of mis-specified $\bar{\gamma}$ on type one error.  


The same parameter settings. The only diffrence is that $\bar{\gamma}=5$ when generating the data and different mis-specified $\bar{\gamma}$ (on x axis) is used to make inference.  
