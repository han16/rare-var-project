...
Parameter settings: N1=N0=3000 $\alpha=\alpha_0=0.1$, $\beta=2000, \beta_0=1000$. 100 genes, each having 1000 variants in three different groups, the first group has 30% variants, the second has 40% and the rest 30% are in the third group. In each variant group of every gene, the proportion  of risk variants  $\eta$ is varying at 0.01, 0.05, 0.1 and every risk category has its own    $\bar{\gamma}=5, 3,1$ respectively. The bsaic idea is that the rarer the varinat is, the more effect size it tends to have.    Perform 100 independent runs. 
