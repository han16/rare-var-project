...
for (i in 3:6)
{
 ...
 load(paste("../output/BayesianFDR/Mixed_Gene_Gammamean3_", "useGammabar", i, ".delta0.1_replicate20.RData", sep="")) 
...
p1=ggplot(actual.fdr.summary, aes(x=bar.gamma, y=mean, group=1)) + 
  ...
  theme(plot.title = element_text(hjust = 0.5, size=10))+  #center the title 
  xlab(expression(paste(bar(gamma))))+
  ylab("Bayesian FDR")+ylim(c(-0.01, max.ylab))+
  guides(fill=guide_legend(title=NULL))+
  #ylim(0.05,0.15)+
...
for (i in 3:6)
{
 ...
 ############ compute posterior probability for every gene ##########
 rm("all.delta.est", "all.BF.gene", "all.mirage.pvalue", "all.skat.pvalue", "all.fisher.pvalue", "all.Ui")
 load(paste("../output/BayesianFDR/Mixed_Gene_Gammamean4_", "useGammabar", i, ".delta0.1_replicate20.RData", sep="")) 
...
for (i in 3:6)
{
 ...
 ############ compute posterior probability for every gene ##########
 rm("all.delta.est", "all.BF.gene", "all.mirage.pvalue", "all.skat.pvalue", "all.fisher.pvalue", "all.Ui")
 load(paste("../output/BayesianFDR/Mixed_Gene_Gammamean5_", "useGammabar", i, ".delta0.1_replicate20.RData", sep="")) 
...
p3=ggplot(actual.fdr.summary, aes(x=bar.gamma, y=mean, group=1)) + 
  ...
  theme(plot.title = element_text(hjust = 0.5, size=10))+  #center the title 
  xlab(expression(paste(bar(gamma))))+
  ylab("Bayesian FDR")+ylim(c(0, max.ylab))+  
  guides(fill=guide_legend(title=NULL))+
  #ylim(0.05,0.15)+
   geom_hline(yintercept=bayesian.fdr,linetype="dashed", color = "red")+
  theme(axis.title.y=element_text(size=8)) # adjust text size for y labels
...
for (i in 3:6)
{
 ...
 ############ compute posterior probability for every gene ##########
 rm("all.delta.est", "all.BF.gene", "all.mirage.pvalue", "all.skat.pvalue", "all.fisher.pvalue", "all.Ui")
 load(paste("../output/BayesianFDR/Mixed_Gene_Gammamean6_", "useGammabar", i, ".delta0.1_replicate20.RData", sep="")) 
