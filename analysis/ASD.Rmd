...
Anno.Data=All.Anno.Data[which(All.Anno.Data$ExacAF<1e-2 & All.Anno.Data$Annotation!="synonymous SNV"),] # use AF cutoff and exclude synonumous SNV
...
* use $10^{-2}$ as AF cutoff and exclude synonymous SNV
...
## Gene level analysis
```{r burdern analysis-gene level, results='hide', echo=F, cache=T}
...
```
**Gene level: two sample one side ("greater") test;  high confidence gene: q<0.1, SFARI cate1&2; Moder confi: 0.3>q>0.1 SFARI cat3 & S**
```{r gene level, }
