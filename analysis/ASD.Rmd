...
############ remove deplicate rows because of redundency of defining combined features. 
#if two rows have same MIRAGE.pvalue, then they are deplicates 
MIRAGE.pvalue=Burden.MIRAGE.combine.clear$MIRAGE.pvalue
MIRAGE.pvalue.unique=unique(MIRAGE.pvalue)
MIRAGE.pvalue.unique.index=match(MIRAGE.pvalue.unique, MIRAGE.pvalue)
############
