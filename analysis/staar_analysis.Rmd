...
############
  ...
  ##################### 
   ...
   acat_group_pvalue[g]=ACAT(acat_var_pvalue, acat_var_weight)  
    ...
    if (max(acat_group_pvalue)==1)
      acat_group_pvalue[cat_group_pvalue==1]=1-1/(length(acat_group_pvalue))
 ...
 # write.csv(data.frame(Gene=interest_gene, ACAT_pvalue=acat_gene_pvalue), file="../output/KyleData/AllGene_6vargroups_ACAT_pvalue_0328_2023.csv")
...
```{r, echo=F, message=F, warning=F}
staar_pvalue=as_tibble(read.csv("../output/KyleData/AllGene_6vargroups_ACAT_pvalue_0328_2023.csv"))
