...
ggplot(merged_df, aes(x = post.prob_entire, y = post.prob_entire_with_SPARK_parameters)) +
  ...
  geom_abline(intercept = 0, slope = 1, linetype = "dashed", color = "red") +
  labs(
    x = "PP from entire dataset using parameters from entire dataset",
    y = "PP from entire dataset using parameters from SPARK dataset",
    title = ""
  ) +
  theme_minimal(base_size = 14)+
  theme(
...
ggplot(merged_df, aes(x = post.prob_entire, y = post.prob_entire_with_ASC_parameters)) +
  ...
  labs(
    x = "PP from entire dataset using parameters  from entire dataset",
    y = "PP from entire dataset using parameters  from ASC dataset",
    title = ""
  ) +
  theme_minimal(base_size = 14)+
  theme(
