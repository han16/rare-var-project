...
But the calculated numbers are quite different from the statistics in cell paper! 

```{r, echo=F}
PTV_cate1=ASC_new_sample %>% filter(pLI>=0.995) %>% select(Variant, Gene, Gnomad_non_neuro_AF, Transmitted_proband, Untransmitted_proband)
