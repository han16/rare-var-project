...
old_ID_liftover=paste(substr(old_data_liftover$seqnames, 4, old_pos_liftover), old_data_liftover$start, sep=":") # extract loci position without "chr", starting from 4th position to the end, to be consistent with format with other data 
...
* in the two figures in the bottom, old samples are liftover, a larger number of loci (194,511, 11.82%, 194,511/1,645,623) are overlapping between new sample and liftover sample of old data.  
