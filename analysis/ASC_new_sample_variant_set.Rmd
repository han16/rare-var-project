...
transmitted_variant=ASC_new_sample2%>%select(starts_with(c("t", "u")))
...
rare_missense_variant_new_sample=ASC_new_sample2 %>% filter(Consequence=="missense_variant")%>% filter(Gnomad_non_neuro_AF<0.0001) %>% select(Variant, Gene, Transmitted_proband, Untransmitted_proband)  # missense variant in new sample data with AF<1-10-4
