...
cell_variant_set=cell_trans_data_AF %>% filter(Consequence=="[missense_variant]")%>% filter(ExacAF<0.0001) %>% select(Variant, GENE_NAME, Transmitted_proband, Untransmitted_proband)  # LoF variant in cell data with AF<1-10-4
