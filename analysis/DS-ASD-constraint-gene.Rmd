...
Anno.Data=DS.ASD.sample[which(DS.ASD.sample$ExacAF<0.01 & DS.ASD.sample$Annotation!="synonymous SNV"),] # use AF cutoff and exclude synonumous SNV
...
#save(parameter.estimate, BF.PP.gene, file="../output/para.est.constraint.gene.estimate.delta.DS.ASD.AFcutoff1%.RData")
