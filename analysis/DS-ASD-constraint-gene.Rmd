...
parameter.estimate=matrix(nrow=9, ncol=2)
...
rownames(parameter.estimate)=c("delta", paste("deta", seq(1,8), sep=""))
colnames(parameter.estimate)=c("esyimate", "pval")
BF.PP.gene=ds.asd.result$BF.PP.gene
#save(parameter.estimate, BF.PP.gene, file="../output/para.est.constraint.gene.estimate.delta.DS.ASD.RData")
