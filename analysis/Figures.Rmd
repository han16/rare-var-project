...
folder_path="C:/Shengtong/Research/rare-var/RareVariant/CodeandDataforPaper/Data/"

load(paste0(folder_path, "AUC_summary.rdata"))
...
for (delta in delta_all) {
  ...
  load(paste0(folder_path, "7methods_delta",delta, "_gammamean335_5rep.RData"))
