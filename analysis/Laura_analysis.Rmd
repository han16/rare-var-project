...
topmirage.enrichment.tidy=data.frame(class=c(rep("han_v17",length(Gene_Set)+1), rep("All Genes", length(Gene_Set)+1), rep("laura_v17", length(Gene_Set)+1), rep("laura_all", length(Gene_Set)+1), rep("all_combined", length(Gene_Set)+1)), group=rep(c(Gene_Set, "SFARI"),5), percent=c(han_v17_percent, all_gene_percent, laura_v17_percent, laura_all_percent, all_combined_percent))
######################
