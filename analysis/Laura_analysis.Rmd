...
Top_genes=result$BayesFactor[order(result$BayesFactor$BF, decreasing = T),]$Gene[1:18]
Top_gene_variant_BF=list()
for (i in 1:length(Top_genes))
  Top_gene_variant_BF[[i]]=result$full.info[[which(result$BayesFactor$Gene==Top_genes[i])]]

#save(Top_gene_variant_BF, file=paste(path, "ASC\\Laura_result\\top_gene_T&UT_variant_BF_20231114.RData", sep=""))
```
