...
laura_v17_percent=numeric(); laura_all_percent=numeric()
pvalue=numeric()
...
topmirage.enrichment.tidy=data.frame(class=c(rep("han_v17",length(Gene_Set)+1), rep("All Genes", length(Gene_Set)+1), rep("laura_v17", length(Gene_Set)+1), rep("laura_all", length(Gene_Set)+1)), group=rep(c(Gene_Set, "SFARI"),4), percent=c(han_v17_percent, all_gene_percent, laura_v17_percent, laura_all_percent))
######################
