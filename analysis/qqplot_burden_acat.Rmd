...
new_data=mirage_input_with_gnomad_AF %>%  filter(Gnomad_non_neuro_AF<0.05) %>% filter(Gene %in% interest_gene) %>% select(Variant, Gene, Gnomad_non_neuro_AF, Transmitted_proband, Untransmitted_proband, Group_Index) %>% drop_na()  #apply AF filter AF<5% 
...
#  write.csv(data.frame(Gene=interest_gene[1:16344], ACAT_pvalue=acat_gene_pvalue), file="../output/LauraData/AllGene_6vargroups_ACAT_pvalue_2023_1107.csv")
...
staar_pvalue=as_tibble(read.csv("../output/LauraData/AllGene_6vargroups_ACAT_pvalue_2023_1107.csv"))
...
################
 ...
 # write.csv(p_value_005, file="../output/LauraData/All_inherited_variants_6vargroups_burden_binom_oneside_pvalues_MPC_larger_than2_AF0.05_2023_1107.csv")
#  write.csv(combine_005, file="../output/KyleData/All_inherited_variants_6vargroups_burden_counts_binom_oneside_pvalues_MPC_larger_than2_AF0.05_1208_2022.csv")
...
#  colnames(p_value_001)=c("LoF_pvalue", "All_variants_pvalue", "fisher_combine_pvalue", "LoF_ACAT_pvalue", "Missense_ACAT_pvalue")
 ...
 # write.csv(p_value_001, file="../output/LauraData/All_inherited_variants_6vargroups_burden_binom_oneside_pvalues_MPC_larger_than2_AF0.01_0208_2023.csv")
#  write.csv(combine_001, file="../output/LauraData/All_inherited_variants_6vargroups_burden_counts_binom_oneside_pvalues_MPC_larger_than2_AF0.01_1208_2022.csv")
...
```{r, echo=T, message=F, warning=F}
burden_pvalues_001=as_tibble(read.csv("../output/LauraData/All_inherited_variants_6vargroups_burden_binom_oneside_pvalues_MPC_larger_than2_AF0.01_2023_1107.csv"))
combine_001=as_tibble(read.csv("../output/LauraData/All_inherited_variants_6vargroups_burden_counts_binom_oneside_pvalues_MPC_larger_than2_AF0.01_2023_1107.csv"))
